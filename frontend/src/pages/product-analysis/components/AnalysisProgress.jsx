  ...
  const analysisSteps = [
    {
      ...
      icon: "Upload",
      description: "Processing product images",
    },
    {
      id: "ocr",
      label: "Text Recognition",
      icon: "ScanText",
      description: "Reading information from product labels",
    },
    {
      id: "analysis",
      label: "Ingredient Analysis",
      icon: "Beaker",
      description: "Evaluating each ingredient",
    },
    {
      id: "risk",
      label: "Risk Assessment",
      icon: "Shield",
      description: "Calculating safety levels",
    },
    {
      id: "complete",
      label: "Completed",
      ...
      <div className="glass-card rounded-xl p-8 max-w-md w-full mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground font-caption">
            AI is processing and analyzing your product information
          </p>
        </div>
